...
- (void)requestSendCode {
    ...
    [THTTPRequestTool postRequestDataWithUrl:@"api/sms/send" par:@{@"data":@{@"mobile":kUnNilStr(self.userNameTxt.text),@"event":@"register",@"type":@(2)}} finishBlock:^(TResponse *response) {
