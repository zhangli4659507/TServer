...
@property (nonatomic, copy) NSString *unseal_phone;//下单人手机号
@property (nonatomic, copy) NSString *unseal_wx;//下单人微信号
...
@property (nonatomic, copy) NSString *province_name;//接单省份
@end
