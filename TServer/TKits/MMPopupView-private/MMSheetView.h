...
@class MMSheetView;
@protocol MMSheetViewDelegate <NSObject>

- (void)sheetView:(MMSheetView *)sheetView selectIndex:(NSInteger)index;
...
- (instancetype) initWithTitle:(NSString*)title
                         items:(NSArray<MMPopupItem *>*)items delegate:(id<MMSheetViewDelegate>)delgate;
